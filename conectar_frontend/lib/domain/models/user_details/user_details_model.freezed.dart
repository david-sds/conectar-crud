...
class _$UserDetailsImpl implements _UserDetails {
  ...
  @override
  String toString() {
    return 'UserDetails(id: $id, name: $name, email: $email, role: $role, clients: $clients, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, role,
      const DeepCollectionEquality().hash(_clients), createdAt, updatedAt);
...
abstract class _UserDetails implements UserDetails {
  const factory _UserDetails(
      ...
      final List<Client>? clients,
      final DateTime? createdAt,
      final DateTime? updatedAt}) = _$UserDetailsImpl;
